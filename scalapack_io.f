      SUBROUTINE PZLAWRITEBIN( FILNAM, M, N, A, IA, JA, DESCA, IRWRIT,
     $                      ICWRIT, WORK )
*
...
*     further adapted to write unformatted binary file by Martin Stoehr,
*     February 2017 (martin.stoehr@uni.lu)
*
*     .. Scalar Arguments ..
...
*
*
      SUBROUTINE PDLAWRITEBIN( FILNAM, M, N, A, IA, JA, DESCA, IRWRIT,
     $                      ICWRIT, WORK )
*
*  -- ScaLAPACK tools routine (version 1.8) --
*     University of Tennessee, Knoxville, Oak Ridge National Laboratory,
